// Türkiye 81 İl ve İlçeleri — Statik Veri
...
export const TURKEY_CITIES: TurkeyCity[] = [
  ...
  {
    name: 'Hatay',
    districts: ['Altınözü','Antakya','Arsuz','Belen','Defne','Dörtyol','Erzin','Hassa','İskenderun','Kırıkhan','Kumlu','Payas','Reyhanlı','Samandağ','Serinyol','Yayladağı'],
  },
  {
    name: 'Iğdır',
  ...
  {
    name: 'Malatya',
    districts: ['Akçadağ','Arapgir','Arguvan','Battalgazi','Darende','Doğanşehir','Doğanyol','Hekimhan','Kale','Kuluncak','Merkez','Pütürge','Yazıhan','Yeşilyurt'],
  },
  {
    name: 'Manisa',
  ...
  {
    name: 'Muğla',
    districts: ['Bodrum','Dalaman','Datça','Fethiye','Kavaklıdere','Köyceğiz','Marmaris','Menteshe','Milas','Ortaca','Seydikemer','Ula','Yatağan'],
  },
  {
    name: 'Muş',
  ...
  {
    name: 'Trabzon',
    districts: ['Akçaabat','Araklı','Arsin','Beşikdüzü','Çarşıbaşı','Çaykara','Dernekpazarı','Düzköy','Hayrat','Köprübaşı','Maçka','Merkez','Of','Ortahisar','Sürmene','Şalpazarı','Tonya','Vakfıkebir','Yomra'],
  },
  {
    name: 'Tunceli',
  ...
  {
    name: 'Van',
    districts: ['Bahçesaray','Başkale','Çatak','Çaldıran','Edremit','Erciş','Gevaş','Gürpınar','İpekyolu','Muradiye','Özalp','Saray','Tuşba'],
  },
  {
    name: 'Yalova',
