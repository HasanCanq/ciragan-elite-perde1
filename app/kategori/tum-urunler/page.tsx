...
export default async function AllProductsPage({ searchParams }: AllProductsPageProps) {
  ...
  // Virtual "All Products" category
  const allProductsCategory: Category = {
    id: 'all',
    name: 'Tüm Koleksiyon',
    slug: 'tum-urunler',
    description: 'Evinize zarafet katan, premium kalite perde koleksiyonumuzu keşfedin. Her biri özenle seçilmiş kumaşlardan, kişiye özel ölçülerinize göre üretilmektedir.',
    image_url: null,
    display_order: 0,
    is_active: true,
        ...
        <div className="text-center py-16 bg-white rounded-xl shadow-sm">
          ...
          <p className="text-elite-gray mb-8 max-w-md mx-auto">
            {currentFilters.minPrice || currentFilters.maxPrice
              ...
              : 'Henüz ürün bulunmuyor. Lütfen daha sonra tekrar kontrol edin.'}
          </p>
          <Link
            href="/"
