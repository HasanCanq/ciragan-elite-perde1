...
import { getCategory, getProductsByCategory, getCategories } from "@/lib/actions";
        ...
        {products.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-lg shadow-elite">
            ...
            <p className="text-elite-gray mb-8 max-w-md mx-auto">
              Şu anda bu kategoride gösterilecek ürün bulunmuyor. Lütfen daha sonra tekrar kontrol edin veya diğer kategorilerimize göz atın.
            </p>
            <Link
              href="/"
